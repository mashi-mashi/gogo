...
func (o *AddPetOK) WithPayload(payload *models.APIResponse) *AddPetOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add pet o k response
func (o *AddPetOK) SetPayload(payload *models.APIResponse) {
	o.Payload = payload
}
